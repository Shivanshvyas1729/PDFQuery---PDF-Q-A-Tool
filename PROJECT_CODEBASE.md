# PDFQuery - Modern, Production-Grade RAG Architecture Reference

This codebase uses modern LangChain (v0.2+) best practices, Chroma vector storage, Streamlit, and pre-built chains (`create_retrieval_chain` + `create_stuff_documents_chain`).
...
class Embedder:
    ...
    def __init__(self):
        # Recursive splitter respects paragraphs and sentence boundaries
